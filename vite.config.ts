...
export default defineConfig({ plugins: [react(), searchApiPlugin(), corpusStatsApiPlugin(), workApiPlugin(), youtubeBackfillPlugin(), catalogSearchPlugin()], test: { environment: 'node' } });
