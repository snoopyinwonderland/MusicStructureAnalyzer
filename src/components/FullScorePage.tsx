  ...
  return <main className="score-page">
    ...
    {work && <div className="score-layout">
      ...
      <aside>
        ...
        {phraseEnabled&&<PhraseReviewPanel work={work} boundaryIndex={selectedPhraseBoundary} onSelect={setSelectedPhraseBoundary}/>}
