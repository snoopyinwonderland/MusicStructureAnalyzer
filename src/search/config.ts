export const SEARCH_CONFIG = {
  ...
  weights: { melody: { pitch: .55, interval: .25, contour: .20, rhythm: 0 }, melody_rhythm: { pitch: .42, interval: .20, contour: .13, rhythm: .25 }, contour: { pitch: 0, interval: .2, contour: .8, rhythm: 0 } },
